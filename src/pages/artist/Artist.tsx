    ...
    <>
      <div className="Artist-container">
        <div className="Artist-heading">
          <img className="Card-image" src={artist.imageUrl} alt="Artist" />
          <div>
            <h1>{artist.name}</h1>
      ...
      <div className="Center">
        <div className="List-grid">
          {artist.carousel.images.map(
            (image: { resized: { url: string | undefined } }) => (
              <div className="Art-card">
                <img className="Art-image" src={image.resized.url} alt="Artist" />
              </div>
            )
          )}
        </div>
...
const Artist: React.FC = () => {
  ...
  return <div className="Inner">{name && <Info />}</div>;
};
